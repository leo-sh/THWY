...
- (void)initNVBar{
    ...
    self.dropView = [[DropMenuTableView alloc] initWithWidth:145.f itemHeight:45.f itemNames:@[@"我要报修", @"我要投诉", @"账号信息",@"我的积分", @"推送设置", @"技术支持", @"版本更新"] ItemImages:@[@"main_1", @"main_2", @"main_6",@"main_3", @"main_4", @"main_5", @"main_versionrefresh"]];
