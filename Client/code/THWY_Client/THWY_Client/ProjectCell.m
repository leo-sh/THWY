...
- (IBAction)projectSelect:(UIButton *)sender {
    ...
    [My_ServicesManager getEstates:^(NSString *errorMsg, NSArray *list) {
        if (errorMsg) {
            ...
            self.alertTableView = [[AlertEstateTableView alloc] initWithFrame:CGRectMake(0, 0, My_ScreenW-40, 44.0*self.estateArray.count + 40.0/667*My_ScreenH) style:UITableViewStylePlain];
...
- (IBAction)blockSelect:(UIButton *)sender {
    ...
    [My_ServicesManager getBlock:[self.estateArray[self.estateIndex] estate_id] onComplete:^(NSString *errorMsg, NSArray *list) {
        ...
        [SVProgressHUD dismiss];
        self.alertTableView = [[AlertEstateTableView alloc] initWithFrame:CGRectMake(0, 0, My_ScreenW-40, 44.0*self.blockArray.count + 40.0/667*My_ScreenH) style:UITableViewStylePlain];
...
- (IBAction)unitSelect:(UIButton *)sender {
    ...
    [My_ServicesManager getUnit:[self.estateArray[self.estateIndex] estate_id] block:self.blockArray[self.blockIndex] onComplete:^(NSString *errorMsg, NSArray *list) {
        ...
        [SVProgressHUD dismiss];
        self.alertTableView = [[AlertEstateTableView alloc] initWithFrame:CGRectMake(0, 0, My_ScreenW-40, 44.0*self.unitArray.count + 40.0/667*My_ScreenH) style:UITableViewStylePlain];
...
- (IBAction)layerSelect:(UIButton *)sender {
    ...
    [My_ServicesManager getLayer:[self.estateArray[self.estateIndex] estate_id] block:self.blockArray[self.blockIndex] unit:self.unitArray[self.unitIndex] onComplete:^(NSString *errorMsg, NSArray *list) {
        ...
        [SVProgressHUD dismiss];
        self.alertTableView = [[AlertEstateTableView alloc] initWithFrame:CGRectMake(0, 0, My_ScreenW-40, 44.0*self.layerArray.count + 40.0/667*My_ScreenH) style:UITableViewStylePlain];
